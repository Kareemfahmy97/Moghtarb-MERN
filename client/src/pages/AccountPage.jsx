...
const AccountPage = () => {
  ...
  return (
    <div>
      <nav className="flex w-full justify-center gap-3 mt-12 mb-12">
        <Link to={"/account"} className={activeClass("profile")}>
          <svg
        ...
        <Link to={"/account/bookings"} className={activeClass("bookings")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <Link to={"/account/places"} className={activeClass("places")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
