export default function Perks({ selected, onChange }) {
  ...
  return (
    <>
      <label className="text-xl mt-4 font-bold">Perks</label>
      <div className="grid mt-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2">
        <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
          <input type="checkbox" onChange={checkBoxHandler} name="tv" />
          <svg
        ...
        <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
          <input type="checkbox" onChange={checkBoxHandler} name="guests" />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
          <input type="checkbox" onChange={checkBoxHandler} name="pets" />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
